...
filename  = sys.argv[1] #NEON_2019_D08_DELA_20190429
foldername = sys.argv[2] #NEON_2019_D08_DELA_20190429_all

images_dir   = os.path.join(home,foldername)
export_dir   = home+"/coeffs/"
export_img   = home+"/imagery/"
#jsons_dir    = home+"/coeffs/"
#print(images_dir)
config_file = os.path.join(home,"ic_config_"+filename+"_new.json")
...
config_dict['export'] = {}
config_dict['export']['coeffs']  = False #True
...
#print(jsons_dir)
#print(glob.glob(jsons_dir+'*topo_coeffs_.json'))
config_dict["topo"]['coeff_files'] =  dict(zip(images,glob.glob(os.path.join(export_dir,"*topo_coeffs_.json"))))
...
config_dict["brdf"]['coeff_files'] =  dict(zip(images,glob.glob(os.path.join(export_dir,"*brdf_coeffs_.json"))))
#------------------------------
